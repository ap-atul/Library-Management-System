...
public class Admin_Page {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\AP_Atul Patare\\Desktop\\Wp\\Library System\\skullcandy_wallpaper_dark_by_antman1591.jpg"));
		...
		pass.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try{
					java.sql.Connection con= initDB.getConnection();
					java.sql.PreparedStatement ps=con.prepareStatement("select * from admins",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
					ResultSet rs=ps.executeQuery();
